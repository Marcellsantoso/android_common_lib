...
public class SimpleMonthView extends View {
	...
	private void drawMonthDayLabels(Canvas canvas) {
		...
		for (int day = 0; day < this.mNumDays; day++) {
			...
			canvas.drawText(mDateFormatSymbols.getShortWeekdays()[this.mDayLabelCalendar
	...
	public SimpleMonthAdapter.CalendarDay getDayFromLocation(float x, float y) {
		...
		int day = 1
				+ ((int) ((x - padding) * this.mNumDays / (this.mWidth - padding - this.mPadding)) - findDayOffset())
				+ yDay * this.mNumDays;
		// If day out of range
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		setMeasuredDimension(View.MeasureSpec.getSize(widthMeasureSpec), this.mRowHeight
				* this.mNumRows + MONTH_HEADER_SIZE);
	}
	...
	public boolean onTouchEvent(MotionEvent motionEvent) {
		if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
			SimpleMonthAdapter.CalendarDay calendarDay = getDayFromLocation(motionEvent.getX(),
					motionEvent.getY());
			if (calendarDay != null)
