package com.iapps.external.datetimepicker.timepicker.time;
...
public class TimePickerDialog extends DialogFragment implements
	...
	public interface OnTimeSetListener {
		 ...
		 */
		void onTimeSet(RadialPickerLayout view, DateTime time);
	}
	 ...
	 *            The minimum increment for the minutes selector.
	 */
		...
		mDoneButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mCallback != null) {
					mCallback.onTimeSet(
							mTimePicker,
							DateTime.now().withHourOfDay(mTimePicker.getHours())
									.withMinuteOfHour(mTimePicker.getMinutes()));
				}
				dismiss();
			}
		});
	...
	private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
		...
		com.nineoldandroids.animation.ObjectAnimator pulseAnimator = Utils.getPulseAnimator(
